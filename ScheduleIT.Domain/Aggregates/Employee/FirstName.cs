...
namespace ScheduleIT.Domain.Aggregates.Employee
{
    ...
    public sealed class FirstName : ValueObject
    {
        ...
        public static Result<FirstName> Create(string firstName) =>
            Result.Create(firstName, DomainErrors.EmployeeFirstName.NullOrEmpty)
                .Ensure(f => !string.IsNullOrWhiteSpace(f), DomainErrors.EmployeeFirstName.NullOrEmpty)
                .Ensure(f => f.Length <= MaxLength, DomainErrors.EmployeeFirstName.LongerThanAllowed)
