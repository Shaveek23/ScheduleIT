...
namespace ScheduleIT.Domain.Aggregates.Shared
{
    ...
    public sealed class Email : ValueObject
    {
        ...
        public static Result<Email> Create(string email) =>
            Result.Create(email, DomainErrors.Shared.Email.NullOrEmpty)
                .Ensure(e => !string.IsNullOrWhiteSpace(e), DomainErrors.Shared.Email.NullOrEmpty)
                .Ensure(e => e.Length <= MaxLength, DomainErrors.Shared.Email.LongerThanAllowed)
                .Ensure(e => EmailFormatRegex.Value.IsMatch(e), DomainErrors.Shared.Email.InvalidFormat)
                .Map(e => new Email(e));
